...
def action(curr_node, storage, parent, graph, animate, goal):
	length = len(storage)
	found = False
	# animate = graph.copy()
	...
	if ul:
		if check(ul_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(ul_node, storage)
	...
	if ur:
		if check(ur_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(ur_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1.4:
			storage[location][0][1] = storage[parent][0][1]+1.4
			storage[location][0][2] = parent
		elif not yes:
	...
	if dl:
		if check(dl_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(dl_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1.4:
			storage[location][0][1] = storage[parent][0][1]+1.4
			storage[location][0][2] = parent
		elif not yes:
	...
	if dr:
		if check(dr_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(dr_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1.4:
			storage[location][0][1] = storage[parent][0][1]+1.4
			storage[location][0][2] = parent
		elif not yes:
	...
	if up:
		if check(up_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(up_node, storage)
	...
	if down:
		if check(down_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(down_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1:
			storage[location][0][1] = storage[parent][0][1]+1
			storage[location][0][2] = parent
		elif not yes:
	...
	if left:
		...
		yes, location = exist(left_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1:
			storage[location][0][1] = storage[parent][0][1]+1
			storage[location][0][2] = parent
		elif not yes:
	...
	if right:
		if check(right_node, goal):
			...
			# length += 1
			return storage, animate, found
		yes, location = exist(right_node, storage)
		if yes and storage[location][0][1] > storage[parent][0][1]+1:
			storage[location][0][1] = storage[parent][0][1]+1
			storage[location][0][2] = parent
		elif not yes:
...
def dijkstra(initial, goal):
	...
	while not check(curr_node, goal) and not found:
		storage, animate, found = action(storage[counter][0][0].copy(), storage.copy(), counter, graph, animate, goal)
		counter += 1
		# print(counter)
