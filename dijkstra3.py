...
def move_ul(node, graph):
	if ((node[0]-7 >= 0 and node[1]-7 >= 0) or (node[0]-1 >= 0 and node[1]-1 >= 0)) and ((node[0]-7 >= 0 and node[1]-7 >= 0) and graph[node[0]-7, node[1]-7] == 0):
		return True, [node[0]-1, node[1]-1]
	else:
		return False, None

def move_ur(node, graph):
	if ((node[0]-7 >= 0 and node[1]+7 <= graph.shape[1]-1) or (node[0]-1 >= 0 and node[1]+1 <= graph.shape[1]-1)) and ((node[0]-7 >= 0 and node[1]+7 <= graph.shape[1]-1) and graph[node[0]-7, node[1]+7] == 0):
		return True, [node[0]-1, node[1]+1]
	else:
		return False, None

def move_dl(node, graph):
	if ((node[0]+7 <= graph.shape[0]-1 and node[1]-7 >= 0) or (node[0]+1 <= graph.shape[0]-1 and node[1]-1 >= 0)) and ((node[0]+7 <= graph.shape[0]-1 and node[1]-7 >= 0) and graph[node[0]+7, node[1]-7] == 0):
		return True, [node[0]+1, node[1]-1]
	else:
		return False, None

def move_dr(node, graph):
	if ((node[0]+7 <= graph.shape[0]-1 and node[1]+7 <= graph.shape[1]-1) or (node[0]+1 <= graph.shape[0]-1 and node[1]+1 <= graph.shape[1]-1)) and ((node[0]+7 <= graph.shape[0]-1 and node[1]+7 <= graph.shape[1]-1) and graph[node[0]+7, node[1]+7] == 0):
		return True, [node[0]+1, node[1]+1]
	else:
		return False, None
